...
BEGIN
	...
	BEGIN
		SET @ERR_MESSAGE = 'Invalid input(s). userId, listingId, quoteStatusId, quoteCurrencyId, quoteAmount, estimatedTurnaround and useDefaultLocation must not be null.';
		SET @ERR_IND = 1;
	END
